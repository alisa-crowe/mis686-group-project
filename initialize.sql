...
INSERT INTO Book (BookID, Title, ISBN, AuthorID, Genre, PublisherID, PublicationDate, Price, QuantityInStock) VALUES
    (1, 'Mystery at the Mansion', '1234567890123', 1, 'Mystery', 17, '2022-01-01', 19.99, 50),
    (2, 'Journey to Mars', '9876543210987', 18, 'Science Fiction', 2, '2023-05-15', 24.99, 30),
    (3, 'The Lost Treasure', '1234567890124', 12, 'Adventure', 12, '2021-07-21', 15.99, 40),
    (4, 'Space Odyssey', '9876543210988', 18, 'Science Fiction', 10, '2023-08-10', 22.99, 25),
    (5, 'Haunted House', '1234567890125', 6, 'Horror', 6, '2020-10-31', 18.99, 35),
    (6, 'Galactic Wars', '9876543210989', 18, 'Science Fiction', 2, '2022-12-12', 26.99, 20),
    (7, 'Secret of the Pyramid', '1234567890126', 17, 'Mystery', 1, '2021-03-15', 17.99, 45),
    (8, 'Alien Invasion', '9876543210990', 10, 'Science Fiction', 10, '2023-01-25', 23.99, 28),
    (9, 'The Enchanted Forest', '1234567890127', 14, 'Fantasy', 7, '2022-05-05', 20.99, 32),
    (10, 'Robots and AI', '9876543210991', 10, 'Science Fiction', 2, '2023-09-09', 27.99, 18),
    (11, 'The Hidden Cave', '1234567890128', 24, 'Adventure', 24, '2021-11-11', 16.99, 38),
    (12, 'Mars Colony', '9876543210992', 2, 'Science Fiction', 10, '2022-06-06', 25.99, 22),
    (13, 'Ghosts of the Past', '1234567890129', 16, 'Horror', 16, '2020-09-09', 19.99, 30),
    (14, 'Future World', '9876543210993', 10, 'Science Fiction', 2, '2023-04-04', 28.99, 24),
    (15, 'Mystery of the Old Mill', '1234567890130', 1, 'Mystery', 1, '2021-02-02', 18.99, 42),
    (16, 'Space Explorers', '9876543210994', 18, 'Science Fiction', 10, '2023-07-07', 24.99, 26),
    (17, 'The Dark Forest', '1234567890131', 14, 'Fantasy', 14, '2022-08-08', 21.99, 34),
    (18, 'AI Revolution', '9876543210995', 2, 'Science Fiction', 2, '2023-11-11', 29.99, 16),
    (19, 'The Secret Island', '1234567890132', 12, 'Adventure', 24, '2021-12-12', 17.99, 36),
    (20, 'Journey Beyond Earth', '9876543210996', 10, 'Science Fiction', 10, '2022-03-03', 26.99, 20),
    (21, 'Haunted Castle', '1234567890133', 1, 'Horror', 16, '2020-11-11', 19.99, 28),
    (22, 'Galactic Empire', '9876543210997', 18, 'Science Fiction', 2, '2023-02-02', 27.99, 22),
    (23, 'Mystery of the Lost City', '1234567890134', 17, 'Mystery', 17, '2021-04-04', 18.99, 40),
    (24, 'Alien Worlds', '9876543210998', 2, 'Science Fiction', 10, '2023-06-06', 25.99, 24),
    (25, 'The Magic Realm', '1234567890135', 19, 'Fantasy', 19, '2022-10-10', 22.99, 30);
