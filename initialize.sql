...
DROP TABLE IF EXISTS InventorySupplier;
...
CREATE TABLE Book(
   ...
   InventoryID SMALLINT UNSIGNED NOT NULL, 
   PRIMARY KEY(BookID),
...
CREATE TABLE Returns(
    ...
    FOREIGN KEY (CustomerID) REFERENCES Orders (CustomerID) ON DELETE CASCADE ON UPDATE CASCADE,
    CHECK (QuantityReturned > 0)
);


CREATE TABLE InventorySupplier(
	InventorySupplierID SMALLINT UNSIGNED NOT NULL UNIQUE AUTO_INCREMENT,
    SupplierID SMALLINT UNSIGNED NOT NULL,
    InventoryID SMALLINT UNSIGNED NOT NULL,
    QuantitySupplied SMALLINT UNSIGNED NOT NULL,
    SupplyDate DATE NOT NULL,
    PRIMARY KEY(InventorySupplierID),
    FOREIGN KEY(SupplierID) REFERENCES Supplier (SupplierID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (InventoryID) REFERENCES Inventory (InventoryID) ON DELETE RESTRICT ON UPDATE CASCADE
);


CREATE INDEX idx_supplier_id ON InventorySupplier(SupplierID);
...
INSERT INTO Supplier (SupplierID, Name, Address, Email, PhoneNumber) VALUES
    ...
    INSERT INTO Inventory (InventoryID, QuantityInStock) VALUES
    (1, 50),
    (2, 30),
    (3, 40),
    (4, 25),
...
INSERT INTO Book (BookID, Title, ISBN, AuthorID, Genre, PublisherID, PublicationDate, Price, InventoryID) VALUES
    (1, 'Mystery at the Mansion', '1234567890123', 1, 'Mystery', 17, '2022-01-01', 19.99, 1),
    (2, 'Journey to Mars', '9876543210987', 18, 'Science Fiction', 2, '2023-05-15', 24.99, 2),
    (3, 'The Lost Treasure', '1234567890124', 12, 'Adventure', 12, '2021-07-21', 15.99, 3),
    (4, 'Space Odyssey', '9876543210988', 18, 'Science Fiction', 10, '2023-08-10', 22.99, 4),
    (5, 'Haunted House', '1234567890125', 6, 'Horror', 6, '2020-10-31', 18.99, 5),
    (6, 'Galactic Wars', '9876543210989', 18, 'Science Fiction', 2, '2022-12-12', 26.99, 6),
    (7, 'Secret of the Pyramid', '1234567890126', 17, 'Mystery', 1, '2021-03-15', 17.99, 7),
    (8, 'Alien Invasion', '9876543210990', 10, 'Science Fiction', 10, '2023-01-25', 23.99, 8),
    (9, 'The Enchanted Forest', '1234567890127', 14, 'Fantasy', 7, '2022-05-05', 20.99, 9),
    (10, 'Robots and AI', '9876543210991', 10, 'Science Fiction', 2, '2023-09-09', 27.99, 10),
    (11, 'The Hidden Cave', '1234567890128', 24, 'Adventure', 24, '2021-11-11', 16.99, 11),
    (12, 'Mars Colony', '9876543210992', 2, 'Science Fiction', 10, '2022-06-06', 25.99, 12),
    (13, 'Ghosts of the Past', '1234567890129', 16, 'Horror', 16, '2020-09-09', 19.99, 13),
    (14, 'Future World', '9876543210993', 10, 'Science Fiction', 2, '2023-04-04', 28.99, 14),
    (15, 'Mystery of the Old Mill', '1234567890130', 1, 'Mystery', 1, '2021-02-02', 18.99, 15),
    (16, 'Space Explorers', '9876543210994', 18, 'Science Fiction', 10, '2023-07-07', 24.99, 16),
    (17, 'The Dark Forest', '1234567890131', 14, 'Fantasy', 14, '2022-08-08', 21.99, 17),
    (18, 'AI Revolution', '9876543210995', 2, 'Science Fiction', 2, '2023-11-11', 29.99, 18),
    (19, 'The Secret Island', '1234567890132', 12, 'Adventure', 24, '2021-12-12', 17.99, 19),
    (20, 'Journey Beyond Earth', '9876543210996', 10, 'Science Fiction', 10, '2022-03-03', 26.99, 20),
    (21, 'Haunted Castle', '1234567890133', 1, 'Horror', 16, '2020-11-11', 19.99, 21),
    (22, 'Galactic Empire', '9876543210997', 18, 'Science Fiction', 2, '2023-02-02', 27.99, 22),
    (23, 'Mystery of the Lost City', '1234567890134', 17, 'Mystery', 17, '2021-04-04', 18.99, 23),
    (24, 'Alien Worlds', '9876543210998', 2, 'Science Fiction', 10, '2023-06-06', 25.99, 24),
    (25, 'The Magic Realm', '1234567890135', 19, 'Fantasy', 19, '2022-10-10', 22.99, 25);



INSERT INTO Orders (OrderID, CustomerID, OrderDate, OrderStatus, TotalAmount, ShippingAddress) VALUES
    (1, 1, '2023-01-01', 'Shipped', 59.97, '123 Main St, Anytown, USA'),
    (2, 2, '2023-01-05', 'Delivered', 49.98, '456 Oak St, Anytown, USA'),
    (3, 3, '2023-01-10', 'Processing', 39.99, '789 Pine St, Anytown, USA'),
    (4, 4, '2023-01-15', 'Cancelled', 29.99, '101 Maple St, Anytown, USA'),
    (5, 5, '2023-01-20', 'Shipped', 19.99, '202 Elm St, Anytown, USA'),
    (6, 6, '2023-01-25', 'Delivered', 89.97, '303 Birch St, Anytown, USA'),
    (7, 7, '2023-01-30', 'Processing', 79.96, '404 Cedar St, Anytown, USA'),
    (8, 8, '2023-02-01', 'Shipped', 69.95, '505 Spruce St, Anytown, USA'),
    (9, 9, '2023-02-05', 'Delivered', 59.94, '606 Fir St, Anytown, USA'),
    (10, 10, '2023-02-10', 'Processing', 49.93, '707 Walnut St, Anytown, USA'),
    (11, 11, '2023-02-15', 'Cancelled', 39.92, '808 Chestnut St, Anytown, USA'),
    (12, 12, '2023-02-20', 'Shipped', 29.91, '909 Ash St, Anytown, USA'),
    (13, 13, '2023-02-25', 'Delivered', 19.90, '1010 Poplar St, Anytown, USA'),
    (14, 14, '2023-03-01', 'Processing', 99.89, '1111 Cypress St, Anytown, USA'),
    (15, 15, '2023-03-05', 'Shipped', 89.88, '1212 Redwood St, Anytown, USA'),
    (16, 16, '2023-03-10', 'Delivered', 79.87, '1313 Sequoia St, Anytown, USA'),
    (17, 17, '2023-03-15', 'Processing', 69.86, '1414 Magnolia St, Anytown, USA'),
    (18, 18, '2023-03-20', 'Cancelled', 59.85, '1515 Willow St, Anytown, USA'),
    (19, 19, '2023-03-25', 'Shipped', 49.84, '1616 Pine St, Anytown, USA'),
    (20, 20, '2023-03-30', 'Delivered', 39.83, '1717 Maple St, Anytown, USA'),
    (21, 21, '2023-04-01', 'Processing', 29.82, '1818 Elm St, Anytown, USA'),
    (22, 22, '2023-04-05', 'Cancelled', 19.81, '1919 Birch St, Anytown, USA'),
    (23, 23, '2023-04-10', 'Shipped', 99.80, '2020 Cedar St, Anytown, USA'),
    (24, 24, '2023-04-15', 'Delivered', 89.79, '2121 Spruce St, Anytown, USA'),
    (25, 25, '2023-04-20', 'Processing', 79.78, '2222 Fir St, Anytown, USA');
...
INSERT INTO Returns (ReturnID, OrderID, BookID, ReturnDate, QuantityReturned, Reason, CustomerID) VALUES
    (1, 1, 1, '2023-01-10', 1, 'Reason for returning book 1 from order 1.', 1),
    (2, 2, 2, '2023-01-15', 2, 'Reason for returning book 2 from order 2.', 2),
    (3, 3, 3, '2023-01-20', 1, 'Reason for returning book 3 from order 3.', 3),
    (4, 4, 4, '2023-01-25', 3, 'Reason for returning book 4 from order 4.', 4),
    (5, 5, 5, '2023-01-30', 2, 'Reason for returning book 5 from order 5.', 5),
    (6, 6, 6, '2023-02-01', 1, 'Reason for returning book 6 from order 6.', 6),
    (7, 7, 7, '2023-02-05', 2, 'Reason for returning book 7 from order 7.', 7),
    (8, 8, 8, '2023-02-10', 1, 'Reason for returning book 8 from order 8.', 8),
    (9, 9, 9, '2023-02-15', 3, 'Reason for returning book 9 from order 9.', 9),
    (10, 10, 10, '2023-02-20', 2, 'Reason for returning book 10 from order 10.', 10),
    (11, 11, 11, '2023-02-25', 1, 'Reason for returning book 11 from order 11.', 11),
    (12, 12, 12, '2023-03-01', 2, 'Reason for returning book 12 from order 12.', 12),
    (13, 13, 13, '2023-03-05', 1, 'Reason for returning book 13 from order 13.', 13),
    (14, 14, 14, '2023-03-10', 3, 'Reason for returning book 14 from order 14.', 14),
    (15, 15, 15, '2023-03-15', 2, 'Reason for returning book 15 from order 15.', 15),
    (16, 16, 16, '2023-03-20', 1, 'Reason for returning book 16 from order 16.', 16),
    (17, 17, 17, '2023-03-25', 2, 'Reason for returning book 17 from order 17.', 17),
    (18, 18, 18, '2023-03-30', 1, 'Reason for returning book 18 from order 18.', 18),
    (19, 19, 19, '2023-04-01', 3, 'Reason for returning book 19 from order 19.', 19),
    (20, 20, 20, '2023-04-05', 2, 'Reason for returning book 20 from order 20.', 20),
    (21, 21, 21, '2023-04-10', 1, 'Reason for returning book 21 from order 21.', 21),
    (22, 22, 22, '2023-04-15', 2, 'Reason for returning book 22 from order 22.', 22),
    (23, 23, 23, '2023-04-20', 1, 'Reason for returning book 23 from order 23.', 23),
    (24, 24, 24, '2023-04-25', 3, 'Reason for returning book 24 from order 24.', 24),
    (25, 25, 25, '2023-04-30', 2, 'Reason for returning book 25 from order 25.', 25);
    
    
    INSERT INTO InventorySupplier (InventorySupplierID, SupplierID, InventoryID, QuantitySupplied, SupplyDate) VALUES
    (1, 1, 1, 100, '2023-01-01'),
    (2, 2, 2, 150, '2023-01-05'),
    (3, 3, 3, 200, '2023-01-10'),
    (4, 4, 4, 250, '2023-01-15'),
    (5, 5, 5, 300, '2023-01-20'),
    (6, 6, 6, 350, '2023-01-25'),
    (7, 7, 7, 400, '2023-02-01'),
    (8, 8, 8, 450, '2023-02-05'),
    (9, 9, 9, 500, '2023-02-10'),
    (10, 10, 10, 550, '2023-02-15'),
    (11, 11, 11, 600, '2023-02-20'),
    (12, 12, 12, 650, '2023-02-25'),
    (13, 13, 13, 700, '2023-03-01'),
    (14, 14, 14, 750, '2023-03-05'),
    (15, 15, 15, 800, '2023-03-10'),
    (16, 16, 16, 850, '2023-03-15'),
    (17, 17, 17, 900, '2023-03-20'),
    (18, 18, 18, 950, '2023-03-25'),
    (19, 19, 19, 1000, '2023-03-30'),
    (20, 20, 20, 1050, '2023-04-01'),
    (21, 21, 21, 1100, '2023-04-05'),
    (22, 22, 22, 1150, '2023-04-10'),
    (23, 23, 23, 1200, '2023-04-15'),
    (24, 24, 24, 1250, '2023-04-20'),
    (25, 25, 25, 1300, '2023-04-25');
...
CREATE USER 'employee' IDENTIFIED BY 'books123';

DROP USER IF EXISTS 'trainee';
CREATE USER 'trainee' IDENTIFIED BY 'books123';


GRANT SELECT, INSERT, UPDATE, DELETE ON Bookstore.* TO 'employee';
GRANT SELECT, UPDATE ON Bookstore.* TO 'trainee';
