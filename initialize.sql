...
CREATE TABLE Author(
   AuthorID SMALLINT UNSIGNED NOT NULL UNIQUE,
...
CREATE TABLE Customer(
   CustomerID SMALLINT UNSIGNED NOT NULL UNIQUE,
   FirstName VARCHAR(100) NOT NULL,
   LastName VARCHAR(100) NOT NULL,
...
CREATE TABLE Publisher(
   PublisherID SMALLINT UNSIGNED NOT NULL UNIQUE,
...
CREATE TABLE Supplier(
   SupplierID SMALLINT UNSIGNED NOT NULL UNIQUE,
   Name VARCHAR(100) NOT NULL,
   Address VARCHAR(300),
   Email VARCHAR(100) NOT NULL UNIQUE,
   PhoneNumber VARCHAR(15) NOT NULL,
...
CREATE TABLE Book(
   BookID SMALLINT UNSIGNED NOT NULL UNIQUE,
   Title VARCHAR(100),
...
CREATE TABLE Inventory(
   InventoryID SMALLINT UNSIGNED NOT NULL UNIQUE,
...
CREATE TABLE Orders(
   OrderID SMALLINT UNSIGNED NOT NULL UNIQUE,
...
CREATE TABLE OrderItem(
   OrderItemID SMALLINT UNSIGNED NOT NULL UNIQUE,
...
CREATE TABLE Payment(
   PaymentID SMALLINT UNSIGNED NOT NULL UNIQUE,
   OrderID SMALLINT UNSIGNED NOT NULL,
   PaymentMethod VARCHAR(100) NOT NULL,
...
CREATE TABLE Review(
   ReviewID SMALLINT UNSIGNED NOT NULL UNIQUE,
   BookID SMALLINT UNSIGNED NOT NULL,
   CustomerID SMALLINT UNSIGNED NOT NULL,
...
CREATE TABLE Returns(
   ReturnID SMALLINT UNSIGNED NOT NULL UNIQUE,
   OrderID SMALLINT UNSIGNED NOT NULL,
   BookID SMALLINT UNSIGNED NOT NULL,
